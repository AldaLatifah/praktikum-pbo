            ...
            switch(select){
                ...
                case 2:
                    ...
                    for (int i = 0; i < dataMahasiswa.size(); i++) {
                        ...
                        System.out.println("Nama : " +  dataMahasiswa.get(i).name);
                        System.out.println("Nim : " +  dataMahasiswa.get(i).nim);
                    }
                break;
                case 3:
                    ...
                    for (Mahasiswa mahasiswa : dataMahasiswa) {
                        if (mahasiswa.nim.equals(search)) {
                            System.out.print("Nama Mahasiswa  : ");
                    ...
                    // //search by index
                    // for (int i = 0; i<dataMahasiswa.size(); i++) {
                    //     if(dataMahasiswa.get(i).nim.equals(nim)){
                    //         System.out.print("Nama Mahasiswa  : ");
                ...
                case 4:
                    ...
                    for (int i = 0; i<dataMahasiswa.size(); i++) {
                        if(dataMahasiswa.get(i).nim.equals(search)){
